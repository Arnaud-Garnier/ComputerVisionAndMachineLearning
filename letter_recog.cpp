...
// Fonction permettant de charger un classifier déjà entraîné au format xml
template<typename T>
...
// Pour sauvegarder un classifier au format de notre choix (xml ou yaml)
                                     ...
                                     const string& filename_to_save)
{
    ...
    for( i = 0; i < nsamples_all; i++ )
    {
        ...
        // r contient le caractère : il faut le caster en char !!
        // il faut que sample soit une matrice 1 ligne et 256 colonnes (la matrice de la lettre)
        // la méthode predict va se charger d'aller chercher la lettre
                      ...
                      const string& filename_to_load )
{
    ...
    else
    {
        ...
        // 2. train classifier
        int layer_sz[] = { data.cols, 8, 8, 8, class_count };
...
int main( int argc, char *argv[] )
{
    ...
    cv::CommandLineParser parser(argc, argv, "{data|letter.txt|}{save||}{load||}"
            "{mlp||}{help h||}");
